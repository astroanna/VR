...
public class PointCloudGenerator : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        for (int i = 0; i < numDivisions; i++)
        {
            ...
            GameObject obj = Instantiate(Resources.Load("PointCloudContainer")) as GameObject;
            obj.name = "ControllableEmpty";
            ...
            obj.GetComponent<OVRGrabbable>().enabled = !(obj.GetComponent<OVRGrabbable>().enabled);
            pointClouds[i] = obj;
        }
