...
public class OVRGrabber : MonoBehaviour
{
    ...
    void OnUpdatedAnchors()
    {
        ...
        //Vector3 fixedRot = destRot.eulerAngles;
        //this.transform.Rotate(fixedRot);
    ...
    void OnTriggerEnter(Collider otherCollider)
    {
        ...
        grabbable.transform.GetComponent<Renderer>().material = yellow;
    }
    ...
    void OnTriggerExit(Collider otherCollider)
    {
        ...
        grabbable.transform.GetComponent<Renderer>().material = red;
    }
